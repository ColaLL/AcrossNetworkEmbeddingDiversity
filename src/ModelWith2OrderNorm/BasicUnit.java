...
public class BasicUnit {
	...
	public static void Norm(double[] vector_norm)
	{
		double total=0;
		for(int i=0;i<vector_norm.length;i++)
		{
			double double_tempweight=vector_norm[i];
	...
	public static double getCosinDouble(double[] dis_1,double[] dis_2)
	{
		...
		if((Math.sqrt(frac_2_a)*Math.sqrt(frac_2_b))==0)
		{
			return 0;
		}
		double cosin_diver=frac_1/(Math.sqrt(frac_2_a)*Math.sqrt(frac_2_b));
	...
	public static double getInner(double[] dis_1,double[] dis_2)
	{
		double frac_1=0;
		for(int i=0;i<dis_1.length;i++)
		{
	...
	public static ArrayList<Map.Entry<String, Integer>> sortIntMap
	(HashMap<String,Integer> para)
{
	List<Entry<String, Integer>> list = 
			new ArrayList<Entry<String, Integer>>(para.entrySet());
    ...
    //    System.out.println(entry.getKey()+" : "+hashMap.get(entry.getKey()));
    //}
    return (ArrayList<Entry<String, Integer>>) list;
}
